...
import com.HelpDesk.utils.JSON;
...
import static com.HelpDesk.utils.JSONResponses.ERROR_INCORRECT_REQUEST;
...
public class APIHandlerServlet extends HttpServlet {
    ...
    static {
        ...
        map.put("Ticket", TicketServlet.getInstance());
        map.put("Organization", OrganizationAddServlet.getInstance());
